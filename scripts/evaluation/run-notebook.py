...
TASK06C_R2 = "--task06c-r2" in sys.argv
TASK06C_R1 = "--task06c-r1" in sys.argv and not TASK06C_R2
TASK06C = "--task06c" in sys.argv and not TASK06C_R1 and not TASK06C_R2
NOTEBOOK = Path(
    "evaluation/task06c-r2/notebook/ankur_task06c_r2_evaluation.ipynb"
    if TASK06C_R2
...
HTML = Path(
    "evaluation/task06c-r2/notebook/ankur_task06c_r2_evaluation.html"
    if TASK06C_R2
...
def main() -> None:
    ...
    html_parts = [
        f"<!doctype html><html><head><meta charset='utf-8'><title>Ankur {'Task 06C-R2' if TASK06C_R2 else 'Task 06C-R1' if TASK06C_R1 else 'Task 06C' if TASK06C else 'Task 06'} Evaluation</title>",
