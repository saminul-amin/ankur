...
NOTEBOOK = Path("evaluation/notebook/ankur_task06_evaluation.ipynb")
HTML = Path("evaluation/notebook/ankur_task06_evaluation.html")
...
def main() -> None:
    ...
    html_parts = [
        "<!doctype html><html><head><meta charset='utf-8'><title>Ankur Task 06 Evaluation</title>",
