...
TASK06C_R2F = "--task06c-r2f" in sys.argv
TASK06C_R2E = "--task06c-r2e" in sys.argv and not TASK06C_R2F
TASK06C_R2 = "--task06c-r2" in sys.argv and not TASK06C_R2E and not TASK06C_R2F
TASK06C_R1 = "--task06c-r1" in sys.argv and not TASK06C_R2 and not TASK06C_R2E and not TASK06C_R2F
TASK06C = "--task06c" in sys.argv and not TASK06C_R1 and not TASK06C_R2 and not TASK06C_R2E and not TASK06C_R2F
NOTEBOOK = Path(
    "evaluation/task06c-r2f/notebook/ankur_task06c_r2f_evaluation.ipynb"
    if TASK06C_R2F
    else "evaluation/task06c-r2e/notebook/ankur_task06c_r2e_evaluation.ipynb" if TASK06C_R2E
...
HTML = Path(
    "evaluation/task06c-r2f/notebook/ankur_task06c_r2f_evaluation.html"
    if TASK06C_R2F
    else "evaluation/task06c-r2e/notebook/ankur_task06c_r2e_evaluation.html" if TASK06C_R2E
...
def main() -> None:
    ...
    html_parts = [
        f"<!doctype html><html><head><meta charset='utf-8'><title>Ankur {'Task 06C-R2F' if TASK06C_R2F else 'Task 06C-R2E' if TASK06C_R2E else 'Task 06C-R2' if TASK06C_R2 else 'Task 06C-R1' if TASK06C_R1 else 'Task 06C' if TASK06C else 'Task 06'} Evaluation</title>",
